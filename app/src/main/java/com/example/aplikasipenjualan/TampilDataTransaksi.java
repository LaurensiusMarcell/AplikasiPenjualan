...
public class TampilDataTransaksi extends AppCompatActivity implements TransaksiAdaptor.datalistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_data_transaksi);
    ...
    private void GetData() {
        ...
        reference.child("DataBarang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter=new TransaksiAdaptor(dataBarangs, TampilDataTransaksi.this);
